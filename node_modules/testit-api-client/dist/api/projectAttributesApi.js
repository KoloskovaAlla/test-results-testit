...
exports.ProjectAttributesApi = exports.ProjectAttributesApiApiKeys = void 0;
const request_1 = __importDefault(require("request"));
const models_1 = require("../model/models");
const models_2 = require("../model/models");
const apis_1 = require("./apis");
let defaultBasePath = 'http://localhost';
var ProjectAttributesApiApiKeys;
(function (ProjectAttributesApiApiKeys) {
    ProjectAttributesApiApiKeys[ProjectAttributesApiApiKeys["Bearer or PrivateToken"] = 0] = "Bearer or PrivateToken";
})(ProjectAttributesApiApiKeys = exports.ProjectAttributesApiApiKeys || (exports.ProjectAttributesApiApiKeys = {}));
class ProjectAttributesApi {
    ...
    setApiKey(key, value) {
        this.authentications[ProjectAttributesApiApiKeys[key]].apiKey = value;
    }
    ...
    createProjectsAttribute(projectId, customAttributePostModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(customAttributePostModel, "CustomAttributePostModel")
            };
    ...
    deleteProjectsAttribute(projectId, attributeId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getAttributeByProjectId(projectId, attributeId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/api/v2/projects/{projectId}/attributes/{attributeId}'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
                .replace('{' + 'attributeId' + '}', encodeURIComponent(String(attributeId)));
    ...
    getAttributesByProjectId(projectId, isDeleted, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/api/v2/projects/{projectId}/attributes'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<CustomAttributeModel>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    searchAttributesInProject(projectId, skip, take, orderBy, searchField, searchValue, projectAttributesFilterModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(projectAttributesFilterModel, "ProjectAttributesFilterModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<CustomAttributeGetModel>");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    updateProjectsAttribute(projectId, customAttributePutModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/api/v2/projects/{projectId}/attributes'
                .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
            let localVarQueryParameters = {};
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(customAttributePutModel, "CustomAttributePutModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
...
exports.ProjectAttributesApi = ProjectAttributesApi;
//# sourceMappingURL=projectAttributesApi.js.map