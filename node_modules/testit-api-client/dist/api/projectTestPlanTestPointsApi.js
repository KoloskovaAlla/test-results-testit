...
exports.ProjectTestPlanTestPointsApi = exports.ProjectTestPlanTestPointsApiApiKeys = void 0;
const request_1 = __importDefault(require("request"));
const models_1 = require("../model/models");
const models_2 = require("../model/models");
const apis_1 = require("./apis");
let defaultBasePath = 'http://localhost';
var ProjectTestPlanTestPointsApiApiKeys;
(function (ProjectTestPlanTestPointsApiApiKeys) {
    ProjectTestPlanTestPointsApiApiKeys[ProjectTestPlanTestPointsApiApiKeys["Bearer or PrivateToken"] = 0] = "Bearer or PrivateToken";
})(ProjectTestPlanTestPointsApiApiKeys = exports.ProjectTestPlanTestPointsApiApiKeys || (exports.ProjectTestPlanTestPointsApiApiKeys = {}));
class ProjectTestPlanTestPointsApi {
    ...
    setApiKey(key, value) {
        this.authentications[ProjectTestPlanTestPointsApiApiKeys[key]].apiKey = value;
    }
    ...
    apiV2ProjectsProjectIdTestPlansTestPlanIdTestPointsAutotestsRerunPost(projectId, testPlanId, testPlanTestPointsAutoTestsRerunApiModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(testPlanTestPointsAutoTestsRerunApiModel, "TestPlanTestPointsAutoTestsRerunApiModel")
            };
    ...
    apiV2ProjectsProjectIdTestPlansTestPlanIdTestPointsAutotestsRunPost(projectId, testPlanId, testPlanTestPointsAutoTestsRunApiModel, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(testPlanTestPointsAutoTestsRunApiModel, "TestPlanTestPointsAutoTestsRunApiModel")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications['Bearer or PrivateToken'].apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications['Bearer or PrivateToken'].applyToRequest(localVarRequestOptions));
                ...
                return new Promise((resolve, reject) => {
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "TestRunNameApiResult");
                                resolve({ response: response, body: body });
                            }
                            else {
                                reject(new apis_1.HttpError(response, body, response.statusCode));
...
exports.ProjectTestPlanTestPointsApi = ProjectTestPlanTestPointsApi;
//# sourceMappingURL=projectTestPlanTestPointsApi.js.map