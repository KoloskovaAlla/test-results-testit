...
(function (SearchApiApiKeys) {
    SearchApiApiKeys[SearchApiApiKeys["Bearer or PrivateToken"] = 0] = "Bearer or PrivateToken";
...
class SearchApi {
    ...
    apiV2SearchGlobalSearchPost(globalSearchRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(globalSearchRequest, "GlobalSearchRequest")
            };
                    ...
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "GlobalSearchResponse");
