...
exports.ProjectSectionsApi = exports.ProjectSectionsApiApiKeys = void 0;
const request_1 = __importDefault(require("request"));
const models_1 = require("../model/models");
const models_2 = require("../model/models");
const apis_1 = require("./apis");
let defaultBasePath = 'http://localhost';
var ProjectSectionsApiApiKeys;
(function (ProjectSectionsApiApiKeys) {
    ProjectSectionsApiApiKeys[ProjectSectionsApiApiKeys["Bearer or PrivateToken"] = 0] = "Bearer or PrivateToken";
})(ProjectSectionsApiApiKeys = exports.ProjectSectionsApiApiKeys || (exports.ProjectSectionsApiApiKeys = {}));
class ProjectSectionsApi {
    ...
    setApiKey(key, value) {
        this.authentications[ProjectSectionsApiApiKeys[key]].apiKey = value;
    }
    ...
    getSectionsByProjectId(projectId, skip, take, orderBy, searchField, searchValue, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (projectId === null || projectId === undefined) {
                throw new Error('Required parameter projectId was null or undefined when calling getSectionsByProjectId.');
            }
            if (skip !== undefined) {
                    ...
                    (0, request_1.default)(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                body = models_1.ObjectSerializer.deserialize(body, "Array<SectionModel>");
...
exports.ProjectSectionsApi = ProjectSectionsApi;
//# sourceMappingURL=projectSectionsApi.js.map