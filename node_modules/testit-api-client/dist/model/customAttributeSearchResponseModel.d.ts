...
export declare class CustomAttributeSearchResponseModel {
    'workItemUsage': Array<ProjectShortestModel>;
    'testPlanUsage': Array<ProjectShortestModel>;
    'id': string;
...
export declare namespace CustomAttributeSearchResponseModel {
}
